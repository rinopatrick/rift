...
>
  <div class="bg-[#141414] border border-[#2a2a2a] rounded-xl w-[520px] max-w-[90vw] max-h-[85vh] flex flex-col shadow-2xl">
    ...
    <div class="flex items-center justify-between px-5 py-3 border-b border-[#2a2a2a]">
      ...
      <button aria-label="Close settings" onclick={onClose} class="text-[#6b6b6b] hover:text-[#e8e8e8]">
    ...
    <div class="flex-1 overflow-auto p-5 space-y-6">
      ...
      <div>
        ...
        <div class="space-y-3">
          <div class="flex items-center justify-between">
            <span class="text-[12px] text-[#a0a0a0]">Theme</span>
            <select
          ...
          <div class="flex items-center justify-between">
            <span class="text-[12px] text-[#a0a0a0]">Editor font size</span>
          ...
          <div class="flex items-center justify-between">
            <span class="text-[12px] text-[#a0a0a0]">Result font size</span>
            <div class="flex items-center gap-2">
              <input
          ...
          <div class="flex items-center justify-between">
            <span class="text-[12px] text-[#a0a0a0]">Show line numbers</span>
            <button
      ...
      <div>
        ...
        <div class="space-y-3">
          <div class="flex items-center justify-between">
            <span class="text-[12px] text-[#a0a0a0]">Query timeout</span>
            <div class="flex items-center gap-2">
              <input
